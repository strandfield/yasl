...
#ifndef YASL_BINDING_CHAINABLE_MEMFN_H
#define YASL_BINDING_CHAINABLE_MEMFN_H

#include "yasl/common/values.h"

#include "yasl/common/wrappers/chainable_member_wrapper.h"
...
#endif // YASL_BINDING_CHAINABLE_MEMFN_H
