...
template<> struct details::tag_resolver<QDoubleValidator> { typedef qobject_tag tag_type; };
...
template<> struct details::tag_resolver<QIntValidator> { typedef qobject_tag tag_type; };
...
template<> struct details::tag_resolver<QRegularExpressionValidator> { typedef qobject_tag tag_type; };
#endif
template<> struct make_type_helper<QValidator> { inline static script::Type get() { return script::Type::QValidator; } };
template<> struct details::tag_resolver<QValidator> { typedef qobject_tag tag_type; };
