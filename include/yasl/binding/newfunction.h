...
public:
  ...
  {
    return namespace_.newFunction(name, binding::qclass_newfunction_wrapper_t<T>::wrap)
      .returns(make_type<T&>())
      .get();
  }
  ...
  script::Function add(const std::string & name)
  {
    return namespace_.newFunction(name, binding::qclass_newfunction_wrapper_t<T, A1>::wrap)
      .returns(make_type<T&>())
      .params(make_type<A1>())
      .get();
  }
  ...
  script::Function add(const std::string & name)
  {
    return namespace_.newFunction(name, binding::qclass_newfunction_wrapper_t<T, A1, A2>::wrap)
      .returns(make_type<T&>())
  ...
  script::Function add(const std::string & name)
  {
    return namespace_.newFunction(name, binding::qclass_newfunction_wrapper_t<T, A1, A2, A3>::wrap)
      .returns(make_type<T&>())
  ...
  script::Function add(const std::string & name)
  {
    return namespace_.newFunction(name, binding::qclass_newfunction_wrapper_t<T, A1, A2, A3, A4>::wrap)
      .returns(make_type<T&>())
  ...
  script::Function add(const std::string & name)
  {
    return namespace_.newFunction(name, binding::qclass_newfunction_wrapper_t<T, A1, A2, A3, A4, A5>::wrap)
      .returns(make_type<T&>())
