...
struct ref_member_wrapper_t<R(ClassType::*)()const, f> {
  static script::Value wrap(script::FunctionCall *c) {
    ...
    return c->engine()->newPtr(make_type<Proxy<std::decay<R>::type>>(), &((self).*(f))());
  }
};
...
struct ref_member_wrapper_t<R(ClassType::*)(A1)const, f> {
  static script::Value wrap(script::FunctionCall *c) {
    ClassType & self = *value_cast<ClassType*>(c->arg(0));
    return c->engine()->newPtr(make_type<Proxy<std::decay<R>::type>>(), &((self).*(f))(value_cast<A1>(c->arg(1))));
  }
};
...
struct ref_member_wrapper_t<R(ClassType::*)(A1, A2)const, f> {
  static script::Value wrap(script::FunctionCall *c) {
    ClassType & self = *value_cast<ClassType*>(c->arg(0));
    return c->engine()->newPtr(make_type<Proxy<std::decay<R>::type>>(), &((self).*(f))(value_cast<A1>(c->arg(1)), value_cast<A2>(c->arg(2))));
  }
};
...
struct ref_member_wrapper_t<R(ClassType::*)(A1, A2, A3)const, f> {
  static script::Value wrap(script::FunctionCall *c) {
    ClassType & self = *value_cast<ClassType*>(c->arg(0));
    return c->engine()->newPtr(make_type<Proxy<std::decay<R>::type>>(), &((ref).*(f))(value_cast<A1>(c->arg(1)), value_cast<A2>(c->arg(2)), value_cast<A3>(c->arg(3))));
  }
};
...
struct ref_member_wrapper_t<R(ClassType::*)(A1, A2, A3, A4)const, f> {
  static script::Value wrap(script::FunctionCall *c) {
    ClassType & self = *value_cast<ClassType*>(c->arg(0));
    return c->engine()->newPtr(make_type<Proxy<std::decay<R>::type>>(), &((ref).*(f))(value_cast<A1>(c->arg(1)), value_cast<A2>(c->arg(2)), value_cast<A3>(c->arg(3)), value_cast<A4>(c->arg(4))));
  }
};
