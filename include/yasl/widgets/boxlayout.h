...
namespace details { template<> struct tag_resolver<QBoxLayout> { typedef qobject_tag tag_type; }; }
...
namespace details { template<> struct tag_resolver<QHBoxLayout> { typedef qobject_tag tag_type; }; }
template<> struct make_type_helper<QVBoxLayout> { inline static script::Type get() { return script::Type::QVBoxLayout; } };
namespace details { template<> struct tag_resolver<QVBoxLayout> { typedef qobject_tag tag_type; }; }
} // namespace script
