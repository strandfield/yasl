...
namespace details { template<> struct tag_resolver<QChildEvent> { typedef qevent_tag tag_type; }; }
...
namespace details { template<> struct tag_resolver<QDeferredDeleteEvent> { typedef qevent_tag tag_type; }; }
...
namespace details { template<> struct tag_resolver<QDynamicPropertyChangeEvent> { typedef qevent_tag tag_type; }; }
template<> struct make_type_helper<QEvent> { inline static script::Type get() { return script::Type::QEvent; } };
namespace details { template<> struct tag_resolver<QEvent> { typedef qevent_tag tag_type; }; }
...
namespace details { template<> struct tag_resolver<QTimerEvent> { typedef qevent_tag tag_type; }; }
} // namespace script
