...
#ifndef YASL_BINDING2_STATICMEMFUN_H
#define YASL_BINDING2_STATICMEMFUN_H
...
{
  return cla.newMethod(std::move(name), function_wrapper_t<FT, F>::wrap)
    .setStatic()
...
{
  return cla.newMethod(std::move(name), void_function_wrapper_t<FT, F>::wrap)
    .setStatic();
}
...
#endif // YASL_BINDING2_STATICMEMFUN_H
