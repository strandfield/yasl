...
const Engine::map_template_t Engine::MapTemplate = Engine::map_template_t{};

ClassTemplate Engine::getTemplate(map_template_t) const
{
  return d->map_template_;
}

void Engine::setTemplate(passkey, map_template_t, const ClassTemplate & ct)
{
  d->map_template_ = ct;
}
