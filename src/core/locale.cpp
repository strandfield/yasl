...
static void register_locale_class(script::Namespace ns)
{
  ...
  binder.ctors().add<QLocale::Language, QLocale::Country>();
  // QLocale(QLocale::Language, QLocale::Script, QLocale::Country);
  binder.ctors().add<QLocale::Language, QLocale::Script, QLocale::Country>();
  ...
  binder.add_fun<QString, float, char, int, &QLocale::toString>("toString");
  ...
  binder.add_static_void_fun<const QLocale &, &QLocale::setDefault>("setDefault");
  // static QLocale c();
