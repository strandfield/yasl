...
static void register_locale_class(script::Namespace ns)
{
  ...
  binder.ctors().ctor<QLocale::Language, QLocale::Country>().create();
  ...
  binder.fun<QString, double, char, int, &QLocale::toString>("toString").create();
  // QString toString(float, char, int) const;
  binder.fun<QString, float, char, int, &QLocale::toString>("toString").create();
  ...
  binder.fun<QString, QLocale::FormatType, &QLocale::dateFormat>("dateFormat").create();
  // QString timeFormat(QLocale::FormatType) const;
  binder.fun<QString, QLocale::FormatType, &QLocale::timeFormat>("timeFormat").create();
  // QString dateTimeFormat(QLocale::FormatType) const;
  binder.fun<QString, QLocale::FormatType, &QLocale::dateTimeFormat>("dateTimeFormat").create();
  // QDate toDate(const QString &, QLocale::FormatType) const;
  binder.fun<QDate, const QString &, QLocale::FormatType, &QLocale::toDate>("toDate").create();
  // QTime toTime(const QString &, QLocale::FormatType) const;
  binder.fun<QTime, const QString &, QLocale::FormatType, &QLocale::toTime>("toTime").create();
  // QDateTime toDateTime(const QString &, QLocale::FormatType) const;
  binder.fun<QDateTime, const QString &, QLocale::FormatType, &QLocale::toDateTime>("toDateTime").create();
  ...
  binder.fun<QString, int, QLocale::FormatType, &QLocale::monthName>("monthName").create();
  // QString standaloneMonthName(int, QLocale::FormatType) const;
  binder.fun<QString, int, QLocale::FormatType, &QLocale::standaloneMonthName>("standaloneMonthName").create();
  // QString dayName(int, QLocale::FormatType) const;
  binder.fun<QString, int, QLocale::FormatType, &QLocale::dayName>("dayName").create();
  // QString standaloneDayName(int, QLocale::FormatType) const;
  binder.fun<QString, int, QLocale::FormatType, &QLocale::standaloneDayName>("standaloneDayName").create();
  ...
  binder.fun<QString, int, const QString &, &QLocale::toCurrencyString>("toCurrencyString").create();
  ...
  binder.fun<QString, double, const QString &, &QLocale::toCurrencyString>("toCurrencyString").create();
  ...
  binder.fun<QString, float, const QString &, &QLocale::toCurrencyString>("toCurrencyString").create();
  ...
  binder.fun<QString, const QString &, QLocale::QuotationStyle, &QLocale::quoteString>("quoteString").create();
