...
static void register_qt_alignment_flag_enum(script::Namespace qt)
{
  ...
  Enum alignment_flag = qt.Enum("AlignmentFlag").setId(script::Type::QtAlignmentFlag).setEnumClass().get();
  ...
  register_qflags_type<Qt::AlignmentFlag>(qt, "Alignment", Type::QtAlignment);
}
...
static void register_qt_anchor_point_enum(script::Namespace qt)
{
  ...
  Enum anchor_point = qt.Enum("AnchorPoint").setId(script::Type::QtAnchorPoint).setEnumClass().get();
...
static void register_qt_application_attribute_enum(script::Namespace qt)
{
  ...
  Enum application_attribute = qt.Enum("ApplicationAttribute").setId(script::Type::QtApplicationAttribute).setEnumClass().get();
...
static void register_qt_application_state_enum(script::Namespace qt)
{
  ...
  Enum application_state = qt.Enum("ApplicationState").setId(script::Type::QtApplicationState).setEnumClass().get();
  ...
  register_qflags_type<Qt::ApplicationState>(qt, "ApplicationStates", script::Type::QtApplicationStates);
}
...
static void register_qt_arrow_type_enum(script::Namespace qt)
{
  ...
  Enum arrow_type = qt.Enum("ArrowType").setId(script::Type::QtArrowType).setEnumClass().get();
...
static void register_qt_aspect_ratio_mode_enum(script::Namespace qt)
{
  ...
  Enum aspect_ratio_mode = qt.Enum("AspectRatioMode").setId(script::Type::QtAspectRatioMode).setEnumClass().get();
...
static void register_qt_axis_enum(script::Namespace qt)
{
  ...
  Enum axis = qt.Enum("Axis").setId(script::Type::QtAxis).setEnumClass().get();
...
static void register_qt_b_g_mode_enum(script::Namespace qt)
{
  ...
  Enum b_g_mode = qt.Enum("BGMode").setId(script::Type::QtBGMode).setEnumClass().get();
...
static void register_qt_brush_style_enum(script::Namespace qt)
{
  ...
  Enum brush_style = qt.Enum("BrushStyle").setId(script::Type::QtBrushStyle).setEnumClass().get();
...
static void register_qt_case_sensitivity_enum(script::Namespace qt)
{
  ...
  Enum case_sensitivity = qt.Enum("CaseSensitivity").setId(script::Type::QtCaseSensitivity).setEnumClass().get();
...
static void register_qt_check_state_enum(script::Namespace qt)
{
  ...
  Enum check_state = qt.Enum("CheckState").setId(script::Type::QtCheckState).setEnumClass().get();
...
static void register_qt_checksum_type_enum(script::Namespace qt)
{
  ...
  Enum checksum_type = qt.Enum("ChecksumType").setId(script::Type::QtChecksumType).setEnumClass().get();
...
static void register_qt_clip_operation_enum(script::Namespace qt)
{
  ...
  Enum clip_operation = qt.Enum("ClipOperation").setId(script::Type::QtClipOperation).setEnumClass().get();
...
static void register_qt_connection_type_enum(script::Namespace qt)
{
  ...
  Enum connection_type = qt.Enum("ConnectionType").setId(script::Type::QtConnectionType).setEnumClass().get();
...
static void register_qt_context_menu_policy_enum(script::Namespace qt)
{
  ...
  Enum context_menu_policy = qt.Enum("ContextMenuPolicy").setId(script::Type::QtContextMenuPolicy).setEnumClass().get();
...
static void register_qt_coordinate_system_enum(script::Namespace qt)
{
  ...
  Enum coordinate_system = qt.Enum("CoordinateSystem").setId(script::Type::QtCoordinateSystem).setEnumClass().get();
...
static void register_qt_corner_enum(script::Namespace qt)
{
  ...
  Enum corner = qt.Enum("Corner").setId(script::Type::QtCorner).setEnumClass().get();
...
static void register_qt_cursor_move_style_enum(script::Namespace qt)
{
  ...
  Enum cursor_move_style = qt.Enum("CursorMoveStyle").setId(script::Type::QtCursorMoveStyle).setEnumClass().get();
...
static void register_qt_cursor_shape_enum(script::Namespace qt)
{
  ...
  Enum cursor_shape = qt.Enum("CursorShape").setId(script::Type::QtCursorShape).setEnumClass().get();
...
static void register_qt_date_format_enum(script::Namespace qt)
{
  ...
  Enum date_format = qt.Enum("DateFormat").setId(script::Type::QtDateFormat).setEnumClass().get();
...
static void register_qt_day_of_week_enum(script::Namespace qt)
{
  ...
  Enum day_of_week = qt.Enum("DayOfWeek").setId(script::Type::QtDayOfWeek).setEnumClass().get();
...
static void register_qt_dock_widget_area_enum(script::Namespace qt)
{
  ...
  Enum dock_widget_area = qt.Enum("DockWidgetArea").setId(script::Type::QtDockWidgetArea).setEnumClass().get();
  ...
  register_qflags_type<Qt::DockWidgetArea>(qt, "DockWidgetAreas", script::Type::QtDockWidgetAreas);
}
...
static void register_qt_drop_action_enum(script::Namespace qt)
{
  ...
  Enum drop_action = qt.Enum("DropAction").setId(script::Type::QtDropAction).setEnumClass().get();
  ...
  register_qflags_type<Qt::DropAction>(qt, "DropActions", script::Type::QtDropActions);
}
...
static void register_qt_edge_enum(script::Namespace qt)
{
  ...
  Enum edge = qt.Enum("Edge").setId(script::Type::QtEdge).setEnumClass().get();
  ...
  register_qflags_type<Qt::Edge>(qt, "Edges", script::Type::QtEdges);
}
...
static void register_qt_enter_key_type_enum(script::Namespace qt)
{
  ...
  Enum enter_key_type = qt.Enum("EnterKeyType").setId(script::Type::QtEnterKeyType).setEnumClass().get();
...
static void register_qt_event_priority_enum(script::Namespace qt)
{
  ...
  Enum event_priority = qt.Enum("EventPriority").setId(script::Type::QtEventPriority).setEnumClass().get();
...
static void register_qt_fill_rule_enum(script::Namespace qt)
{
  ...
  Enum fill_rule = qt.Enum("FillRule").setId(script::Type::QtFillRule).setEnumClass().get();
...
static void register_qt_find_child_option_enum(script::Namespace qt)
{
  ...
  Enum find_child_option = qt.Enum("FindChildOption").setId(script::Type::QtFindChildOption).setEnumClass().get();
  ...
  register_qflags_type<Qt::FindChildOption>(qt, "FindChildOptions", script::Type::QtFindChildOptions);
}
...
static void register_qt_focus_policy_enum(script::Namespace qt)
{
  ...
  Enum focus_policy = qt.Enum("FocusPolicy").setId(script::Type::QtFocusPolicy).setEnumClass().get();
...
static void register_qt_focus_reason_enum(script::Namespace qt)
{
  ...
  Enum focus_reason = qt.Enum("FocusReason").setId(script::Type::QtFocusReason).setEnumClass().get();
...
static void register_qt_gesture_flag_enum(script::Namespace qt)
{
  ...
  Enum gesture_flag = qt.Enum("GestureFlag").setId(script::Type::QtGestureFlag).setEnumClass().get();
  ...
  register_qflags_type<Qt::GestureFlag>(qt, "GestureFlags", script::Type::QtGestureFlags);
}
...
static void register_qt_gesture_state_enum(script::Namespace qt)
{
  ...
  Enum gesture_state = qt.Enum("GestureState").setId(script::Type::QtGestureState).setEnumClass().get();
...
static void register_qt_gesture_type_enum(script::Namespace qt)
{
  ...
  Enum gesture_type = qt.Enum("GestureType").setId(script::Type::QtGestureType).setEnumClass().get();
...
static void register_qt_global_color_enum(script::Namespace qt)
{
  ...
  Enum global_color = qt.Enum("GlobalColor").setId(script::Type::QtGlobalColor).setEnumClass().get();
...
static void register_qt_hit_test_accuracy_enum(script::Namespace qt)
{
  ...
  Enum hit_test_accuracy = qt.Enum("HitTestAccuracy").setId(script::Type::QtHitTestAccuracy).setEnumClass().get();
...
static void register_qt_image_conversion_flag_enum(script::Namespace qt)
{
  ...
  Enum image_conversion_flag = qt.Enum("ImageConversionFlag").setId(script::Type::QtImageConversionFlag).setEnumClass().get();
...
static void register_qt_input_method_hint_enum(script::Namespace qt)
{
  ...
  Enum input_method_hint = qt.Enum("InputMethodHint").setId(script::Type::QtInputMethodHint).setEnumClass().get();
  ...
  register_qflags_type<Qt::InputMethodHint>(qt, "InputMethodHints", script::Type::QtInputMethodHints);
}
...
static void register_qt_input_method_query_enum(script::Namespace qt)
{
  ...
  Enum input_method_query = qt.Enum("InputMethodQuery").setId(script::Type::QtInputMethodQuery).setEnumClass().get();
  ...
  register_qflags_type<Qt::InputMethodQuery>(qt, "InputMethodQueries", script::Type::QtInputMethodQueries);
}
...
static void register_qt_item_data_role_enum(script::Namespace qt)
{
  ...
  Enum item_data_role = qt.Enum("ItemDataRole").setId(script::Type::QtItemDataRole).setEnumClass().get();
...
static void register_qt_item_flag_enum(script::Namespace qt)
{
  ...
  Enum item_flag = qt.Enum("ItemFlag").setId(script::Type::QtItemFlag).setEnumClass().get();
  ...
  register_qflags_type<Qt::ItemFlag>(qt, "ItemFlags", script::Type::QtItemFlags);
}
...
static void register_qt_item_selection_mode_enum(script::Namespace qt)
{
  ...
  Enum item_selection_mode = qt.Enum("ItemSelectionMode").setId(script::Type::QtItemSelectionMode).setEnumClass().get();
...
static void register_qt_item_selection_operation_enum(script::Namespace qt)
{
  ...
  Enum item_selection_operation = qt.Enum("ItemSelectionOperation").setId(script::Type::QtItemSelectionOperation).setEnumClass().get();
...
static void register_qt_key_enum(script::Namespace qt)
{
  ...
  Enum key = qt.Enum("Key").setId(script::Type::QtKey).setEnumClass().get();
...
static void register_qt_keyboard_modifier_enum(script::Namespace qt)
{
  ...
  Enum keyboard_modifier = qt.Enum("KeyboardModifier").setId(script::Type::QtKeyboardModifier).setEnumClass().get();
...
static void register_qt_layout_direction_enum(script::Namespace qt)
{
  ...
  Enum layout_direction = qt.Enum("LayoutDirection").setId(script::Type::QtLayoutDirection).setEnumClass().get();
...
static void register_qt_mask_mode_enum(script::Namespace qt)
{
  ...
  Enum mask_mode = qt.Enum("MaskMode").setId(script::Type::QtMaskMode).setEnumClass().get();
...
static void register_qt_match_flag_enum(script::Namespace qt)
{
  ...
  Enum match_flag = qt.Enum("MatchFlag").setId(script::Type::QtMatchFlag).setEnumClass().get();
  ...
  register_qflags_type<Qt::MatchFlag>(qt, "MatchFlags", script::Type::QtMatchFlags);
}
...
static void register_qt_modifier_enum(script::Namespace qt)
{
  ...
  Enum modifier = qt.Enum("Modifier").setId(script::Type::QtModifier).setEnumClass().get();
...
static void register_qt_mouse_button_enum(script::Namespace qt)
{
  ...
  Enum mouse_button = qt.Enum("MouseButton").setId(script::Type::QtMouseButton).setEnumClass().get();
  ...
  register_qflags_type<Qt::MouseButton>(qt, "MouseButtons", script::Type::QtMouseButtons);
}
...
static void register_qt_mouse_event_flag_enum(script::Namespace qt)
{
  ...
  Enum mouse_event_flag = qt.Enum("MouseEventFlag").setId(script::Type::QtMouseEventFlag).setEnumClass().get();
  ...
  register_qflags_type<Qt::MouseEventFlag>(qt, "MouseEventFlags", script::Type::QtMouseEventFlags);
}
...
static void register_qt_mouse_event_source_enum(script::Namespace qt)
{
  ...
  Enum mouse_event_source = qt.Enum("MouseEventSource").setId(script::Type::QtMouseEventSource).setEnumClass().get();
...
static void register_qt_native_gesture_type_enum(script::Namespace qt)
{
  ...
  Enum native_gesture_type = qt.Enum("NativeGestureType").setId(script::Type::QtNativeGestureType).setEnumClass().get();
...
static void register_qt_navigation_mode_enum(script::Namespace qt)
{
  ...
  Enum navigation_mode = qt.Enum("NavigationMode").setId(script::Type::QtNavigationMode).setEnumClass().get();
...
static void register_qt_orientation_enum(script::Namespace qt)
{
  ...
  Enum orientation = qt.Enum("Orientation").setId(script::Type::QtOrientation).setEnumClass().get();

  orientation.addValue("Horizontal", Qt::Horizontal);
  orientation.addValue("Vertical", Qt::Vertical);

  register_qflags_type<Qt::Orientation>(qt, "Orientations", script::Type::QtOrientations);
}
...
static void register_qt_pen_cap_style_enum(script::Namespace qt)
{
  ...
  Enum pen_cap_style = qt.Enum("PenCapStyle").setId(script::Type::QtPenCapStyle).setEnumClass().get();
...
static void register_qt_pen_join_style_enum(script::Namespace qt)
{
  ...
  Enum pen_join_style = qt.Enum("PenJoinStyle").setId(script::Type::QtPenJoinStyle).setEnumClass().get();
...
static void register_qt_pen_style_enum(script::Namespace qt)
{
  ...
  Enum pen_style = qt.Enum("PenStyle").setId(script::Type::QtPenStyle).setEnumClass().get();
...
static void register_qt_screen_orientation_enum(script::Namespace qt)
{
  ...
  Enum screen_orientation = qt.Enum("ScreenOrientation").setId(script::Type::QtScreenOrientation).setEnumClass().get();
  ...
  register_qflags_type<Qt::ScreenOrientation>(qt, "ScreenOrientations", script::Type::QtScreenOrientations);
}
...
static void register_qt_scroll_bar_policy_enum(script::Namespace qt)
{
  ...
  Enum scroll_bar_policy = qt.Enum("ScrollBarPolicy").setId(script::Type::QtScrollBarPolicy).setEnumClass().get();
...
static void register_qt_scroll_phase_enum(script::Namespace qt)
{
  ...
  Enum scroll_phase = qt.Enum("ScrollPhase").setId(script::Type::QtScrollPhase).setEnumClass().get();
...
static void register_qt_shortcut_context_enum(script::Namespace qt)
{
  ...
  Enum shortcut_context = qt.Enum("ShortcutContext").setId(script::Type::QtShortcutContext).setEnumClass().get();
...
static void register_qt_size_hint_enum(script::Namespace qt)
{
  ...
  Enum size_hint = qt.Enum("SizeHint").setId(script::Type::QtSizeHint).setEnumClass().get();
...
static void register_qt_size_mode_enum(script::Namespace qt)
{
  ...
  Enum size_mode = qt.Enum("SizeMode").setId(script::Type::QtSizeMode).setEnumClass().get();
...
static void register_qt_sort_order_enum(script::Namespace qt)
{
  ...
  Enum sort_order = qt.Enum("SortOrder").setId(script::Type::QtSortOrder).setEnumClass().get();
...
static void register_qt_tab_focus_behavior_enum(script::Namespace qt)
{
  ...
  Enum tab_focus_behavior = qt.Enum("TabFocusBehavior").setId(script::Type::QtTabFocusBehavior).setEnumClass().get();
...
static void register_qt_text_elide_mode_enum(script::Namespace qt)
{
  ...
  Enum text_elide_mode = qt.Enum("TextElideMode").setId(script::Type::QtTextElideMode).setEnumClass().get();
...
static void register_qt_text_flag_enum(script::Namespace qt)
{
  ...
  Enum text_flag = qt.Enum("TextFlag").setId(script::Type::QtTextFlag).setEnumClass().get();
...
static void register_qt_text_format_enum(script::Namespace qt)
{
  ...
  Enum text_format = qt.Enum("TextFormat").setId(script::Type::QtTextFormat).setEnumClass().get();
...
static void register_qt_text_interaction_flag_enum(script::Namespace qt)
{
  ...
  Enum text_interaction_flag = qt.Enum("TextInteractionFlag").setId(script::Type::QtTextInteractionFlag).setEnumClass().get();
  ...
  register_qflags_type<Qt::TextInteractionFlag>(qt, "TextInteractionFlags", script::Type::QtTextInteractionFlags);
}
...
static void register_qt_tile_rule_enum(script::Namespace qt)
{
  ...
  Enum tile_rule = qt.Enum("TileRule").setId(script::Type::QtTileRule).setEnumClass().get();
...
static void register_qt_time_spec_enum(script::Namespace qt)
{
  ...
  Enum time_spec = qt.Enum("TimeSpec").setId(script::Type::QtTimeSpec).setEnumClass().get();
...
static void register_qt_timer_type_enum(script::Namespace qt)
{
  ...
  Enum timer_type = qt.Enum("TimerType").setId(script::Type::QtTimerType).setEnumClass().get();
...
static void register_qt_tool_bar_area_enum(script::Namespace qt)
{
  ...
  Enum tool_bar_area = qt.Enum("ToolBarArea").setId(script::Type::QtToolBarArea).setEnumClass().get();
...
static void register_qt_tool_button_style_enum(script::Namespace qt)
{
  ...
  Enum tool_button_style = qt.Enum("ToolButtonStyle").setId(script::Type::QtToolButtonStyle).setEnumClass().get();
...
static void register_qt_touch_point_state_enum(script::Namespace qt)
{
  ...
  Enum touch_point_state = qt.Enum("TouchPointState").setId(script::Type::QtTouchPointState).setEnumClass().get();
  ...
  register_qflags_type<Qt::TouchPointState>(qt, "TouchPointStates", script::Type::QtTouchPointStates);
}
...
static void register_qt_transformation_mode_enum(script::Namespace qt)
{
  ...
  Enum transformation_mode = qt.Enum("TransformationMode").setId(script::Type::QtTransformationMode).setEnumClass().get();
...
static void register_qt_u_i_effect_enum(script::Namespace qt)
{
  ...
  Enum u_i_effect = qt.Enum("UIEffect").setId(script::Type::QtUIEffect).setEnumClass().get();
...
static void register_qt_white_space_mode_enum(script::Namespace qt)
{
  ...
  Enum white_space_mode = qt.Enum("WhiteSpaceMode").setId(script::Type::QtWhiteSpaceMode).setEnumClass().get();
...
static void register_qt_widget_attribute_enum(script::Namespace qt)
{
  ...
  Enum widget_attribute = qt.Enum("WidgetAttribute").setId(script::Type::QtWidgetAttribute).setEnumClass().get();
...
static void register_qt_window_frame_section_enum(script::Namespace qt)
{
  ...
  Enum window_frame_section = qt.Enum("WindowFrameSection").setId(script::Type::QtWindowFrameSection).setEnumClass().get();
...
static void register_qt_window_modality_enum(script::Namespace qt)
{
  ...
  Enum window_modality = qt.Enum("WindowModality").setId(script::Type::QtWindowModality).setEnumClass().get();
...
static void register_qt_window_state_enum(script::Namespace qt)
{
  ...
  Enum window_state = qt.Enum("WindowState").setId(script::Type::QtWindowState).setEnumClass().get();
  ...
  register_qflags_type<Qt::WindowState>(qt, "WindowStates", script::Type::QtWindowStates);
}
...
static void register_qt_window_type_enum(script::Namespace qt)
{
  ...
  Enum window_type = qt.Enum("WindowType").setId(script::Type::QtWindowType).setEnumClass().get();
  ...
  register_qflags_type<Qt::WindowType>(qt, "WindowFlags", script::Type::QtWindowFlags);
}

void register_qnamespace_file(script::Namespace root)
{
  using namespace script;

  binding::Namespace binder{ root };

  register_qt_alignment_flag_enum(root);
  register_qt_anchor_point_enum(root);
  register_qt_application_attribute_enum(root);
  register_qt_application_state_enum(root);
  register_qt_arrow_type_enum(root);
  register_qt_aspect_ratio_mode_enum(root);
  register_qt_axis_enum(root);
  register_qt_b_g_mode_enum(root);
  register_qt_brush_style_enum(root);
  register_qt_case_sensitivity_enum(root);
  register_qt_check_state_enum(root);
  register_qt_checksum_type_enum(root);
  register_qt_clip_operation_enum(root);
  register_qt_connection_type_enum(root);
  register_qt_context_menu_policy_enum(root);
  register_qt_coordinate_system_enum(root);
  register_qt_corner_enum(root);
  register_qt_cursor_move_style_enum(root);
  register_qt_cursor_shape_enum(root);
  register_qt_date_format_enum(root);
  register_qt_day_of_week_enum(root);
  register_qt_dock_widget_area_enum(root);
  register_qt_drop_action_enum(root);
  register_qt_edge_enum(root);
  register_qt_enter_key_type_enum(root);
  register_qt_event_priority_enum(root);
  register_qt_fill_rule_enum(root);
  register_qt_find_child_option_enum(root);
  register_qt_focus_policy_enum(root);
  register_qt_focus_reason_enum(root);
  register_qt_gesture_flag_enum(root);
  register_qt_gesture_state_enum(root);
  register_qt_gesture_type_enum(root);
  register_qt_global_color_enum(root);
  register_qt_hit_test_accuracy_enum(root);
  register_qt_image_conversion_flag_enum(root);
  register_qt_input_method_hint_enum(root);
  register_qt_input_method_query_enum(root);
  register_qt_item_data_role_enum(root);
  register_qt_item_flag_enum(root);
  register_qt_item_selection_mode_enum(root);
  register_qt_item_selection_operation_enum(root);
  register_qt_key_enum(root);
  register_qt_keyboard_modifier_enum(root);
  register_qt_layout_direction_enum(root);
  register_qt_mask_mode_enum(root);
  register_qt_match_flag_enum(root);
  register_qt_modifier_enum(root);
  register_qt_mouse_button_enum(root);
  register_qt_mouse_event_flag_enum(root);
  register_qt_mouse_event_source_enum(root);
  register_qt_native_gesture_type_enum(root);
  register_qt_navigation_mode_enum(root);
  register_qt_orientation_enum(root);
  register_qt_pen_cap_style_enum(root);
  register_qt_pen_join_style_enum(root);
  register_qt_pen_style_enum(root);
  register_qt_screen_orientation_enum(root);
  register_qt_scroll_bar_policy_enum(root);
  register_qt_scroll_phase_enum(root);
  register_qt_shortcut_context_enum(root);
  register_qt_size_hint_enum(root);
  register_qt_size_mode_enum(root);
  register_qt_sort_order_enum(root);
  register_qt_tab_focus_behavior_enum(root);
  register_qt_text_elide_mode_enum(root);
  register_qt_text_flag_enum(root);
  register_qt_text_format_enum(root);
  register_qt_text_interaction_flag_enum(root);
  register_qt_tile_rule_enum(root);
  register_qt_time_spec_enum(root);
  register_qt_timer_type_enum(root);
  register_qt_tool_bar_area_enum(root);
  register_qt_tool_button_style_enum(root);
  register_qt_touch_point_state_enum(root);
  register_qt_transformation_mode_enum(root);
  register_qt_u_i_effect_enum(root);
  register_qt_white_space_mode_enum(root);
  register_qt_widget_attribute_enum(root);
  register_qt_window_frame_section_enum(root);
  register_qt_window_modality_enum(root);
  register_qt_window_state_enum(root);
  register_qt_window_type_enum(root);

  // QFlags<Qt::MouseButtons::enum_type> operator|(Qt::MouseButtons::enum_type, Qt::MouseButtons::enum_type);
  binder.operators().or<QFlags<Qt::MouseButtons::enum_type>, Qt::MouseButtons::enum_type, Qt::MouseButtons::enum_type>();
  // QFlags<Qt::MouseButtons::enum_type> operator|(Qt::MouseButtons::enum_type, QFlags<Qt::MouseButtons::enum_type>);
  binder.operators().or<QFlags<Qt::MouseButtons::enum_type>, Qt::MouseButtons::enum_type, QFlags<Qt::MouseButtons::enum_type>>();
  // QIncompatibleFlag operator|(Qt::MouseButtons::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::MouseButtons::enum_type, int>();
  // QFlags<Qt::Orientations::enum_type> operator|(Qt::Orientations::enum_type, Qt::Orientations::enum_type);
  binder.operators().or<QFlags<Qt::Orientations::enum_type>, Qt::Orientations::enum_type, Qt::Orientations::enum_type>();
  // QFlags<Qt::Orientations::enum_type> operator|(Qt::Orientations::enum_type, QFlags<Qt::Orientations::enum_type>);
  binder.operators().or<QFlags<Qt::Orientations::enum_type>, Qt::Orientations::enum_type, QFlags<Qt::Orientations::enum_type>>();
  // QIncompatibleFlag operator|(Qt::Orientations::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::Orientations::enum_type, int>();
  // QFlags<Qt::KeyboardModifiers::enum_type> operator|(Qt::KeyboardModifiers::enum_type, Qt::KeyboardModifiers::enum_type);
  binder.operators().or<QFlags<Qt::KeyboardModifiers::enum_type>, Qt::KeyboardModifiers::enum_type, Qt::KeyboardModifiers::enum_type>();
  // QFlags<Qt::KeyboardModifiers::enum_type> operator|(Qt::KeyboardModifiers::enum_type, QFlags<Qt::KeyboardModifiers::enum_type>);
  binder.operators().or<QFlags<Qt::KeyboardModifiers::enum_type>, Qt::KeyboardModifiers::enum_type, QFlags<Qt::KeyboardModifiers::enum_type>>();
  // QIncompatibleFlag operator|(Qt::KeyboardModifiers::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::KeyboardModifiers::enum_type, int>();
  // QFlags<Qt::WindowFlags::enum_type> operator|(Qt::WindowFlags::enum_type, Qt::WindowFlags::enum_type);
  binder.operators().or<QFlags<Qt::WindowFlags::enum_type>, Qt::WindowFlags::enum_type, Qt::WindowFlags::enum_type>();
  // QFlags<Qt::WindowFlags::enum_type> operator|(Qt::WindowFlags::enum_type, QFlags<Qt::WindowFlags::enum_type>);
  binder.operators().or<QFlags<Qt::WindowFlags::enum_type>, Qt::WindowFlags::enum_type, QFlags<Qt::WindowFlags::enum_type>>();
  // QIncompatibleFlag operator|(Qt::WindowFlags::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::WindowFlags::enum_type, int>();
  // QFlags<Qt::Alignment::enum_type> operator|(Qt::Alignment::enum_type, Qt::Alignment::enum_type);
  binder.operators().or<QFlags<Qt::Alignment::enum_type>, Qt::Alignment::enum_type, Qt::Alignment::enum_type>();
  // QFlags<Qt::Alignment::enum_type> operator|(Qt::Alignment::enum_type, QFlags<Qt::Alignment::enum_type>);
  binder.operators().or<QFlags<Qt::Alignment::enum_type>, Qt::Alignment::enum_type, QFlags<Qt::Alignment::enum_type>>();
  // QIncompatibleFlag operator|(Qt::Alignment::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::Alignment::enum_type, int>();
  // QFlags<Qt::Edges::enum_type> operator|(Qt::Edges::enum_type, Qt::Edges::enum_type);
  binder.operators().or<QFlags<Qt::Edges::enum_type>, Qt::Edges::enum_type, Qt::Edges::enum_type>();
  // QFlags<Qt::Edges::enum_type> operator|(Qt::Edges::enum_type, QFlags<Qt::Edges::enum_type>);
  binder.operators().or<QFlags<Qt::Edges::enum_type>, Qt::Edges::enum_type, QFlags<Qt::Edges::enum_type>>();
  // QIncompatibleFlag operator|(Qt::Edges::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::Edges::enum_type, int>();
  // QFlags<Qt::ImageConversionFlags::enum_type> operator|(Qt::ImageConversionFlags::enum_type, Qt::ImageConversionFlags::enum_type);
  binder.operators().or<QFlags<Qt::ImageConversionFlags::enum_type>, Qt::ImageConversionFlags::enum_type, Qt::ImageConversionFlags::enum_type>();
  ...
  binder.operators().or<QFlags<Qt::ImageConversionFlags::enum_type>, Qt::ImageConversionFlags::enum_type, QFlags<Qt::ImageConversionFlags::enum_type>>();
  // QIncompatibleFlag operator|(Qt::ImageConversionFlags::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::ImageConversionFlags::enum_type, int>();
  // QFlags<Qt::DockWidgetAreas::enum_type> operator|(Qt::DockWidgetAreas::enum_type, Qt::DockWidgetAreas::enum_type);
  binder.operators().or<QFlags<Qt::DockWidgetAreas::enum_type>, Qt::DockWidgetAreas::enum_type, Qt::DockWidgetAreas::enum_type>();
  // QFlags<Qt::DockWidgetAreas::enum_type> operator|(Qt::DockWidgetAreas::enum_type, QFlags<Qt::DockWidgetAreas::enum_type>);
  binder.operators().or<QFlags<Qt::DockWidgetAreas::enum_type>, Qt::DockWidgetAreas::enum_type, QFlags<Qt::DockWidgetAreas::enum_type>>();
  // QIncompatibleFlag operator|(Qt::DockWidgetAreas::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::DockWidgetAreas::enum_type, int>();
  // QFlags<Qt::ToolBarAreas::enum_type> operator|(Qt::ToolBarAreas::enum_type, Qt::ToolBarAreas::enum_type);
  binder.operators().or<QFlags<Qt::ToolBarAreas::enum_type>, Qt::ToolBarAreas::enum_type, Qt::ToolBarAreas::enum_type>();
  // QFlags<Qt::ToolBarAreas::enum_type> operator|(Qt::ToolBarAreas::enum_type, QFlags<Qt::ToolBarAreas::enum_type>);
  binder.operators().or<QFlags<Qt::ToolBarAreas::enum_type>, Qt::ToolBarAreas::enum_type, QFlags<Qt::ToolBarAreas::enum_type>>();
  // QIncompatibleFlag operator|(Qt::ToolBarAreas::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::ToolBarAreas::enum_type, int>();
  // QFlags<Qt::WindowStates::enum_type> operator|(Qt::WindowStates::enum_type, Qt::WindowStates::enum_type);
  binder.operators().or<QFlags<Qt::WindowStates::enum_type>, Qt::WindowStates::enum_type, Qt::WindowStates::enum_type>();
  // QFlags<Qt::WindowStates::enum_type> operator|(Qt::WindowStates::enum_type, QFlags<Qt::WindowStates::enum_type>);
  binder.operators().or<QFlags<Qt::WindowStates::enum_type>, Qt::WindowStates::enum_type, QFlags<Qt::WindowStates::enum_type>>();
  // QIncompatibleFlag operator|(Qt::WindowStates::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::WindowStates::enum_type, int>();
  // QFlags<Qt::ScreenOrientations::enum_type> operator|(Qt::ScreenOrientations::enum_type, Qt::ScreenOrientations::enum_type);
  binder.operators().or<QFlags<Qt::ScreenOrientations::enum_type>, Qt::ScreenOrientations::enum_type, Qt::ScreenOrientations::enum_type>();
  // QFlags<Qt::ScreenOrientations::enum_type> operator|(Qt::ScreenOrientations::enum_type, QFlags<Qt::ScreenOrientations::enum_type>);
  binder.operators().or<QFlags<Qt::ScreenOrientations::enum_type>, Qt::ScreenOrientations::enum_type, QFlags<Qt::ScreenOrientations::enum_type>>();
  // QIncompatibleFlag operator|(Qt::ScreenOrientations::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::ScreenOrientations::enum_type, int>();
  // QFlags<Qt::DropActions::enum_type> operator|(Qt::DropActions::enum_type, Qt::DropActions::enum_type);
  binder.operators().or<QFlags<Qt::DropActions::enum_type>, Qt::DropActions::enum_type, Qt::DropActions::enum_type>();
  // QFlags<Qt::DropActions::enum_type> operator|(Qt::DropActions::enum_type, QFlags<Qt::DropActions::enum_type>);
  binder.operators().or<QFlags<Qt::DropActions::enum_type>, Qt::DropActions::enum_type, QFlags<Qt::DropActions::enum_type>>();
  // QIncompatibleFlag operator|(Qt::DropActions::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::DropActions::enum_type, int>();
  // QFlags<Qt::ItemFlags::enum_type> operator|(Qt::ItemFlags::enum_type, Qt::ItemFlags::enum_type);
  binder.operators().or<QFlags<Qt::ItemFlags::enum_type>, Qt::ItemFlags::enum_type, Qt::ItemFlags::enum_type>();
  // QFlags<Qt::ItemFlags::enum_type> operator|(Qt::ItemFlags::enum_type, QFlags<Qt::ItemFlags::enum_type>);
  binder.operators().or<QFlags<Qt::ItemFlags::enum_type>, Qt::ItemFlags::enum_type, QFlags<Qt::ItemFlags::enum_type>>();
  // QIncompatibleFlag operator|(Qt::ItemFlags::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::ItemFlags::enum_type, int>();
  // QFlags<Qt::MatchFlags::enum_type> operator|(Qt::MatchFlags::enum_type, Qt::MatchFlags::enum_type);
  binder.operators().or<QFlags<Qt::MatchFlags::enum_type>, Qt::MatchFlags::enum_type, Qt::MatchFlags::enum_type>();
  // QFlags<Qt::MatchFlags::enum_type> operator|(Qt::MatchFlags::enum_type, QFlags<Qt::MatchFlags::enum_type>);
  binder.operators().or<QFlags<Qt::MatchFlags::enum_type>, Qt::MatchFlags::enum_type, QFlags<Qt::MatchFlags::enum_type>>();
  // QIncompatibleFlag operator|(Qt::MatchFlags::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::MatchFlags::enum_type, int>();
  // QFlags<Qt::TextInteractionFlags::enum_type> operator|(Qt::TextInteractionFlags::enum_type, Qt::TextInteractionFlags::enum_type);
  binder.operators().or<QFlags<Qt::TextInteractionFlags::enum_type>, Qt::TextInteractionFlags::enum_type, Qt::TextInteractionFlags::enum_type>();
  ...
  binder.operators().or<QFlags<Qt::TextInteractionFlags::enum_type>, Qt::TextInteractionFlags::enum_type, QFlags<Qt::TextInteractionFlags::enum_type>>();
  // QIncompatibleFlag operator|(Qt::TextInteractionFlags::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::TextInteractionFlags::enum_type, int>();
  // QFlags<Qt::InputMethodQueries::enum_type> operator|(Qt::InputMethodQueries::enum_type, Qt::InputMethodQueries::enum_type);
  binder.operators().or<QFlags<Qt::InputMethodQueries::enum_type>, Qt::InputMethodQueries::enum_type, Qt::InputMethodQueries::enum_type>();
  // QFlags<Qt::InputMethodQueries::enum_type> operator|(Qt::InputMethodQueries::enum_type, QFlags<Qt::InputMethodQueries::enum_type>);
  binder.operators().or<QFlags<Qt::InputMethodQueries::enum_type>, Qt::InputMethodQueries::enum_type, QFlags<Qt::InputMethodQueries::enum_type>>();
  // QIncompatibleFlag operator|(Qt::InputMethodQueries::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::InputMethodQueries::enum_type, int>();
  // QFlags<Qt::InputMethodHints::enum_type> operator|(Qt::InputMethodHints::enum_type, Qt::InputMethodHints::enum_type);
  binder.operators().or<QFlags<Qt::InputMethodHints::enum_type>, Qt::InputMethodHints::enum_type, Qt::InputMethodHints::enum_type>();
  // QFlags<Qt::InputMethodHints::enum_type> operator|(Qt::InputMethodHints::enum_type, QFlags<Qt::InputMethodHints::enum_type>);
  binder.operators().or<QFlags<Qt::InputMethodHints::enum_type>, Qt::InputMethodHints::enum_type, QFlags<Qt::InputMethodHints::enum_type>>();
  // QIncompatibleFlag operator|(Qt::InputMethodHints::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::InputMethodHints::enum_type, int>();
  // QFlags<Qt::TouchPointStates::enum_type> operator|(Qt::TouchPointStates::enum_type, Qt::TouchPointStates::enum_type);
  binder.operators().or<QFlags<Qt::TouchPointStates::enum_type>, Qt::TouchPointStates::enum_type, Qt::TouchPointStates::enum_type>();
  // QFlags<Qt::TouchPointStates::enum_type> operator|(Qt::TouchPointStates::enum_type, QFlags<Qt::TouchPointStates::enum_type>);
  binder.operators().or<QFlags<Qt::TouchPointStates::enum_type>, Qt::TouchPointStates::enum_type, QFlags<Qt::TouchPointStates::enum_type>>();
  // QIncompatibleFlag operator|(Qt::TouchPointStates::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::TouchPointStates::enum_type, int>();
  // QFlags<Qt::MouseEventFlags::enum_type> operator|(Qt::MouseEventFlags::enum_type, Qt::MouseEventFlags::enum_type);
  binder.operators().or<QFlags<Qt::MouseEventFlags::enum_type>, Qt::MouseEventFlags::enum_type, Qt::MouseEventFlags::enum_type>();
  // QFlags<Qt::MouseEventFlags::enum_type> operator|(Qt::MouseEventFlags::enum_type, QFlags<Qt::MouseEventFlags::enum_type>);
  binder.operators().or<QFlags<Qt::MouseEventFlags::enum_type>, Qt::MouseEventFlags::enum_type, QFlags<Qt::MouseEventFlags::enum_type>>();
  // QIncompatibleFlag operator|(Qt::MouseEventFlags::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::MouseEventFlags::enum_type, int>();
  // QFlags<Qt::GestureFlags::enum_type> operator|(Qt::GestureFlags::enum_type, Qt::GestureFlags::enum_type);
  binder.operators().or<QFlags<Qt::GestureFlags::enum_type>, Qt::GestureFlags::enum_type, Qt::GestureFlags::enum_type>();
  // QFlags<Qt::GestureFlags::enum_type> operator|(Qt::GestureFlags::enum_type, QFlags<Qt::GestureFlags::enum_type>);
  binder.operators().or<QFlags<Qt::GestureFlags::enum_type>, Qt::GestureFlags::enum_type, QFlags<Qt::GestureFlags::enum_type>>();
  // QIncompatibleFlag operator|(Qt::GestureFlags::enum_type, int);
  binder.operators().or<QIncompatibleFlag, Qt::GestureFlags::enum_type, int>();
}
