...
static void register_clipboard_class(script::Namespace ns)
{
  ...
  binder.void_fun<QClipboard::Mode, &QClipboard::clear>("clear").create();
  ...
  binder.fun<QString, QClipboard::Mode, &QClipboard::text>("text").create();
  // QString text(QString &, QClipboard::Mode) const;
  binder.fun<QString, QString &, QClipboard::Mode, &QClipboard::text>("text").create();
  // void setText(const QString &, QClipboard::Mode);
  binder.void_fun<const QString &, QClipboard::Mode, &QClipboard::setText>("setText").create();
  ...
  binder.fun<QImage, QClipboard::Mode, &QClipboard::image>("image").create();
  // QPixmap pixmap(QClipboard::Mode) const;
  binder.fun<QPixmap, QClipboard::Mode, &QClipboard::pixmap>("pixmap").create();
  // void setImage(const QImage &, QClipboard::Mode);
  binder.void_fun<const QImage &, QClipboard::Mode, &QClipboard::setImage>("setImage").create();
  // void setPixmap(const QPixmap &, QClipboard::Mode);
  binder.void_fun<const QPixmap &, QClipboard::Mode, &QClipboard::setPixmap>("setPixmap").create();
