...
static void register_painter_class(script::Namespace ns)
{
  ...
  binder.void_fun<const QRectF &, Qt::ClipOperation, &QPainter::setClipRect>("setClipRect").create();
  // void setClipRect(const QRect &, Qt::ClipOperation);
  binder.void_fun<const QRect &, Qt::ClipOperation, &QPainter::setClipRect>("setClipRect").create();
  // void setClipRect(int, int, int, int, Qt::ClipOperation);
  binder.void_fun<int, int, int, int, Qt::ClipOperation, &QPainter::setClipRect>("setClipRect").create();
  // void setClipRegion(const QRegion &, Qt::ClipOperation);
  binder.void_fun<const QRegion &, Qt::ClipOperation, &QPainter::setClipRegion>("setClipRegion").create();
  // void setClipPath(const QPainterPath &, Qt::ClipOperation);
  binder.void_fun<const QPainterPath &, Qt::ClipOperation, &QPainter::setClipPath>("setClipPath").create();
  ...
  binder.void_fun<const QTransform &, bool, &QPainter::setTransform>("setTransform").create();
  ...
  binder.void_fun<const QTransform &, bool, &QPainter::setWorldTransform>("setWorldTransform").create();
  ...
  binder.void_fun<const QRectF &, qreal, qreal, Qt::SizeMode, &QPainter::drawRoundedRect>("drawRoundedRect").create();
  // void drawRoundedRect(const QRect &, qreal, qreal, Qt::SizeMode);
  binder.void_fun<const QRect &, qreal, qreal, Qt::SizeMode, &QPainter::drawRoundedRect>("drawRoundedRect").create();
  ...
  binder.void_fun<const QRectF &, const QPixmap &, const QPointF &, &QPainter::drawTiledPixmap>("drawTiledPixmap").create();
  // void drawTiledPixmap(const QRect &, const QPixmap &, const QPoint &);
  binder.void_fun<const QRect &, const QPixmap &, const QPoint &, &QPainter::drawTiledPixmap>("drawTiledPixmap").create();
  ...
  binder.void_fun<const QRectF &, const QImage &, const QRectF &, Qt::ImageConversionFlags, &QPainter::drawImage>("drawImage").create();
  // void drawImage(const QRect &, const QImage &, const QRect &, Qt::ImageConversionFlags);
  binder.void_fun<const QRect &, const QImage &, const QRect &, Qt::ImageConversionFlags, &QPainter::drawImage>("drawImage").create();
  // void drawImage(const QPointF &, const QImage &, const QRectF &, Qt::ImageConversionFlags);
  binder.void_fun<const QPointF &, const QImage &, const QRectF &, Qt::ImageConversionFlags, &QPainter::drawImage>("drawImage").create();
  // void drawImage(const QPoint &, const QImage &, const QRect &, Qt::ImageConversionFlags);
  binder.void_fun<const QPoint &, const QImage &, const QRect &, Qt::ImageConversionFlags, &QPainter::drawImage>("drawImage").create();
  ...
  binder.void_fun<const QRectF &, const QString &, const QTextOption &, &QPainter::drawText>("drawText").create();
  ...
  binder.fun<QRectF, const QRectF &, const QString &, const QTextOption &, &QPainter::boundingRect>("boundingRect").create();
